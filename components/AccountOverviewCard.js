...
import { AccountInfo } from '../screens/data';
    ...
    return (
        <View style={styles.trainerInfoContainer}>
            ...
            <View style={{flexDirection: 'row'}}>
                <Text style={styles.boldQuestion}>Years as a trainer: </Text>
                <Text style={styles.answerText}> {sessionData.yearsAsTrainer}</Text>
            </View>
            <Text style={styles.boldQuestion}>My favorite aspect of training:</Text>
            <Text style={styles.answerText}>{sessionData.favTrainingAspect}</Text>
            <Text style={styles.boldQuestion}>Key takeaway for my clients:</Text>
            <Text style={styles.answerText}>{sessionData.keyTakeaway}</Text>
            <Text style={styles.boldQuestion}>I call my tribe or trainees:</Text>
            <Text style={styles.answerText}>{sessionData.tribeName}</Text>
            <Text style={styles.boldQuestion}>My certifications include:</Text>
            <Text style={styles.answerText}>{sessionData.certificationInclude}</Text>
